[should open bunq app if you have one or display toast - bunq app](bunq://x-bunq-app/token-qr-request-ideal?token=9999)

[should open email app if you have one - mail test](mailto:krawczyk.piotr.91@gmail.com)
